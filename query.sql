...
CREATE TABLE books ("title"varchar(255), "isbn"varchar(255), "pageCount"varchar(255), "authors"varchar(255), "publishDate"varchar(255), "description"varchar(255));
